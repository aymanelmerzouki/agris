        ...
        <div className="min-h-screen pb-20 md:pb-8">
            ...
            <div className="max-w-5xl mx-auto px-4 md:px-6 mt-6">
                <div className="relative mb-6 max-w-sm">
                    ...
                    <input
                        className="w-full bg-white border border-gray-200 text-gray-800 text-sm rounded-xl shadow-sm focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 block p-3 pl-10 placeholder-gray-400 transition-all duration-200 dark:bg-zinc-900 dark:border-green-700 dark:text-zinc-100 dark:placeholder-green-400"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {plantes.map((p) => (
                        <Link key={p.id} to={`/plantes/${p.id}`}
                            className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-800 overflow-hidden hover:shadow-md transition group">
                            ...
                            <div className="p-4">
                                <h2 className="font-bold text-gray-900 dark:text-zinc-100 text-base">{p.nom}</h2>
                                <p className="text-sm text-gray-500 dark:text-zinc-400 mt-0.5">{p.espece} — {p.famille}</p>
                ...
                {meta && (
                    <div className="flex gap-2 mt-6 justify-center">
                        ...
                        <span className="py-2 px-3 text-sm text-gray-600 dark:text-zinc-400">{page} / {meta.last_page}</span>
