            ...
            <div className="max-w-5xl mx-auto px-4 md:px-6 mt-6">
                {showForm && (
                    <form onSubmit={handleSubmit} className="mb-6 space-y-4">
                        ...
                        {/* Card 1 — Plante */}
                        <div className="bg-white dark:bg-emerald-900 p-6 rounded-2xl border border-gray-100 dark:border-emerald-800 shadow-sm">
                            <label className="block mb-2 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Plante *</label>
                            <select className="w-full bg-gray-50/50 dark:bg-emerald-900 border border-gray-200 dark:border-zinc-600 text-gray-800 dark:text-emerald-100 text-sm rounded-xl focus:bg-white focus:ring-4 focus:ring-emerald-500/15 focus:border-emerald-500 block p-3 transition-all outline-none"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        <input className="w-full bg-gray-50/50 dark:bg-emerald-900 border border-gray-200 dark:border-zinc-600 text-gray-800 dark:text-emerald-100 text-sm rounded-xl focus:bg-white focus:ring-4 focus:ring-emerald-500/15 focus:border-emerald-500 block p-3 transition-all outline-none placeholder-gray-400"
                                            type="number" step="0.01" min="0.01" placeholder="ex: 2.5"
                                            value={form.superficie} onChange={(e) => set('superficie')(e.target.value)} required />
                                        <select className="bg-gray-50/50 dark:bg-emerald-900 border border-gray-200 dark:border-zinc-600 text-gray-800 dark:text-emerald-100 text-sm rounded-xl focus:bg-white focus:ring-4 focus:ring-emerald-500/15 focus:border-emerald-500 p-3 transition-all outline-none"
                        ...
                        <div className="bg-white dark:bg-emerald-900 p-6 rounded-2xl border border-gray-100 dark:border-emerald-800 shadow-sm">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input className="w-full bg-gray-50/50 dark:bg-emerald-900 border border-gray-200 dark:border-zinc-600 text-gray-800 dark:text-emerald-100 text-sm rounded-xl focus:bg-white focus:ring-4 focus:ring-emerald-500/15 focus:border-emerald-500 block p-3 transition-all outline-none"
                            ...
                            <div className="mt-6">
                                ...
                                <textarea className="w-full bg-gray-50/50 dark:bg-emerald-900 border border-gray-200 dark:border-zinc-600 text-gray-800 dark:text-emerald-100 text-sm rounded-xl focus:bg-white focus:ring-4 focus:ring-emerald-500/15 focus:border-emerald-500 block p-3 transition-all outline-none placeholder-gray-400"
...
function CultureCard({ s, onDelete }) {
    ...
    if (loading) return (
        <div className="bg-white dark:bg-emerald-900 rounded-2xl p-5 border border-gray-100 dark:border-emerald-800 shadow-sm animate-pulse space-y-3">
    ...
    return (
        <div className="bg-white dark:bg-emerald-900 rounded-2xl p-5 border border-gray-100 dark:border-emerald-800 shadow-sm hover:shadow-md transition-all relative">
            {/* Header */}
            <div className="flex items-start justify-between">
                <div>
                    <h3 className="text-lg font-bold text-gray-800 dark:text-emerald-100">{s.plante?.nom}</h3>
            ...
            {/* Live data block */}
            {liveData && (
                <div className="mt-4 p-3 rounded-lg bg-zinc-50 dark:bg-emerald-900/80 border border-zinc-200 dark:border-emerald-800 text-xs space-y-2">
                    <div className="flex items-center gap-2 text-zinc-600 dark:text-emerald-300 font-medium">
